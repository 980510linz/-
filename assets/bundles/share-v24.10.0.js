...
/* v23.9.20: one-time purge for obsolete Share controls from restored mobile history/BFCache DOM. */
document.querySelectorAll('#nativeShare,#refreshQr,.share-actions').forEach(el=>el.remove());
if(new URLSearchParams(location.search).get('build')==='23.9.20'){
